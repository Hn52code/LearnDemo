...
public class IoTServerDecoder extends ByteToMessageDecoder {

    private static final Logger log = LogManager.getLogger(IoTServerDecoder.class);
    ...
    private Object decode(ChannelHandlerContext ctx, ByteBuf in) {
        ...
        if (check == (dataCheck & 0xff)) {
            ...
            log.error("切断-----解码数据：" + ByteBufUtil.hexDump(in));
