...
public class AepDeviceStatusDemo {
    ...
    public void testApi() throws Exception {
...

        {
            ...
            String body = "{\"productId\":\"15058399\",\"deviceId\":\"e2862fe7296f44898792bebbd8121ce8\",\"datasetId\":\"APPdata\"}";
...

        {
            ...
            // request.setParam..  	// set your request params here
            String body = "{\"productId\":\"15058399\",\"deviceId\":\"e2862fe7296f44898792bebbd8121ce8\"}";
            request.setBody(body.getBytes());
