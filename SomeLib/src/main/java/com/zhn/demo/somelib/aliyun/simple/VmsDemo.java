...
public class VmsDemo {
    ...
    // 主叫号码，显示号码
    static final String VmsPhone = "02022512350";
    // 语音模板
    static final String VmsTemplate = "TTS_149385569";
    static final String VmsTemplate2 = "TTS_149385598";
...
//        request.setCalledShowNumber(VmsPhone);
        //必填-被叫号码
        request.setCalledNumber("18774220168");
        //必填-Tts模板ID
        request.setTtsCode(VmsTemplate2);
        //可选-当模板中存在变量时需要设置此值
        request.setTtsParam("{\"address\":\"深圳市派安石岩石龙仔兴强商贸大厦\"}");
